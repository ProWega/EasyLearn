...
namespace ImageTracking_Video
{
    ...
    public class VideoPlayerBookAgent : MonoBehaviour
    {
        ...
        private static UnityEngine.Video.VideoPlayer player;
        private static bool ready;
        private static bool prepared;
        public static bool found;
        private static bool isCanPlay;
        ...
        public static void StatusChanged()
        {
            ...
            if (found && isCanPlay)
            {
                ...
                if (PlayVidBtnController.isMustPlaying)
                    player.Play();
            }
            else
            {
        ...
        public static void SetVideoIsPlaying()
        {
            if (!isCanPlay)
            {
                Debug.Log("Здесь оно реально запустилось");
                isCanPlay = true;
